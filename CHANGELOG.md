...
- List the pluto card in the chart's home sections (#18)

## [1.6.0] - 2026-08-25

### Added

- Maintenance mode, security updates, and six fixes (#17)

## [1.5.1] - 2026-08-23

### Fixed

- Grafana config and nested example (#16)

## [1.5.0] - 2026-08-19

### Added

- Cascading select fixes, tree polling, and the Egyptian potion (#15)

## [1.4.0] - 2026-08-19

### Added

- Forms potions grafana cards (#14)

## [1.3.0] - 2026-08-17

### Added

- Search field and team approvals (#13)

## [1.2.0] - 2026-08-16

### Added

- Changed the UI themes (#12)

## [1.1.0] - 2026-08-14

### Added

- Platform UI tasks (#11)

## [1.0.1] - 2026-08-12

### Fixed

- Graph text and edit dialog (#10)
...
- Load one production overlay, not two
- Package the migrations directory
