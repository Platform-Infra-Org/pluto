...
//
//   curl http://localhost:7007/api/platform-requests/requests -H 'Content-Type: application/json' \
//     -d '{"kind":"CREATE","resourceType":"bucket","resourceName":"data"}'
//
// List requests:
//
//   curl http://localhost:7007/api/platform-requests/requests
//
// Approve a request:
//
//   curl -X POST http://localhost:7007/api/platform-requests/requests/1/approve -H 'Content-Type: application/json' -d '{}'
