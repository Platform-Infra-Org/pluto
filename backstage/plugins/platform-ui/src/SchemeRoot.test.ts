...
describe('colour schemes', () => {
  ...
  it('keeps one potion per design system, with stable ids', () => {
    ...
    expect(SCHEMES.map(s => s.id)).toEqual(['greek', 'hanami', 'nightshade', 'rimefast', 'egyptian', 'hades', 'foudre', 'slush', 'spiderverse', 'newform', 'papers', 'discord', 'github', 'claude', 'dairy', 'obsidian']);
  });
  ...
  it('gives each mode to exactly one potion', () => {
    ...
    expect([...modes].sort()).toEqual(['claude', 'dairy', 'discord', 'egyptian', 'foudre', 'github', 'greek', 'hades', 'hanami', 'newform', 'nightshade', 'obsidian', 'papers', 'rimefast', 'slush', 'spiderverse']);
  ...
  it('never leaves two modes applied at once', () => {
    ...
    const ALL = ['sc-greek', 'sc-hanami', 'sc-nightshade', 'sc-rimefast', 'sc-egyptian', 'sc-hades', 'sc-foudre', 'sc-slush', 'sc-spiderverse', 'sc-newform', 'sc-papers', 'sc-discord', 'sc-github', 'sc-claude', 'sc-dairy', 'sc-obsidian'];
